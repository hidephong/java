...
import cmp.entities.DeviceLocal;
import cmp.entities.DeviceLocalHome;
...
int id=0;
    ...
    public void editDevice(String Name, String Status) {
         DeviceLocalHome home=lookupDeviceLocal();
         try {
            DeviceLocal p=(DeviceLocal) home.findByDeviceName(Name);
            p.setDvStatus(Status);
    ...
    public List findAll() {
        ...
        int i=0;
         try {
            DeviceLocal p;
         while(i<id){
             p=(DeviceLocal) home.findById(new Integer(i));
             lst.add(p.getDvStatus());
             i++;
         }
         } catch (FinderException ex) {
            ex.printStackTrace();
