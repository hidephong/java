...
import ejb.modul.entity.DeviceLocal;
import ejb.modul.entity.DeviceLocalHome;
 ...
 * @author TuanNA
 */
public class SB implements SessionBean {
  ...
  public void CreateDv() {
        DeviceLocalHome home = lookupDeviceLocal();
        try {
            DeviceLocal d = home.create(new Integer(1));
            d.setDeviceName("A");
            d.setDvStatus("off");
