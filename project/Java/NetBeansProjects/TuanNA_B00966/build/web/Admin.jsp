...
<ul class="art-hmenu">
    ...
    <li><a href="#"><span class="l"></span><span class="r"></span><span class="t">Management</span></a>
        <ul>
		    <li><a href="uploadpic.jsp">Upload File Picture</a></li>
                    <li><a href="LoadCategory">Add new book</a></li>
	    </ul>
    </li>
...
<div class="art-layout-cell art-content">
    <h1>Welcome to My Space Admin</h1>
</div>
    </div>
</div>
