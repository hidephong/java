...
Morris.Donut({
    ...
    data: [
        {label: "Referral1", value: 42.7},
        {label: "Direct", value: 18.3},
        {label: "Social2", value: 12.8},
        {label: "Organic1", value: 36.2}
    ],
...
Morris.Line({
    ...
    data: [
        ...
        { d: '2012-10-29', visits: 1420 },
        { d: '2012-10-30', visits: 1529 },
        { d: '2012-11-01', visits: 1892 },
        { d: '2012-11-02', visits: 1902 },
        { d: '2012-11-03', visits: 1933 },
        { d: '2012-11-04', visits: 1952 },
        { d: '2012-11-05', visits: 1992 },
    ],
    // The name of the data record attribute that contains x-visitss.
    xkey: 'd',
    // A list of names of data record attributes that contain y-visitss.
...
Morris.Bar ({
    ...
    data: [
        ...
        {device: 'iPhone 5', geekbench: 1455},
        {device: 'iPhone 5S', geekbench: 1655},
        {device: 'iPhone 6', geekbench: 2655},
        {device: 'iPhone 6S', geekbench: 3571}
    ],
    xkey: 'device',
    ykeys: ['geekbench'],
    labels: ['Geekbench'],
